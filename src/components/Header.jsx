      ...
      <Navbar expand="lg" sticky="top" className="bg-body-tertiary px-xl-5 px-lg-3 px-md-4 mb-3">
        <Container fluid>
          ...
          >
            ...
            {/* <Offcanvas.Body>
              <Nav className="justify-content-between flex-grow-1 fs-xl-5 fs-6 gap-xl-3 gap-2 fw-semibold">
                <div className="flex-grow-1 fs-xl-5 fs-6 gap-xl-3 gap-2 fw-semibold">
                  <Nav.Link href="/home">Home</Nav.Link>
                  <Nav.Link href="/appointments">Appointments</Nav.Link>
                </div>
                <div className='flex-grow-1 gap-xl-3 gap-2'>
                  <Button variant="outline-primary" className='fw-semibold'>Register</Button>
